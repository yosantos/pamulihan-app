...
return [
    ...
    'fields' => [
        ...
        'buyer' => 'Buyer',
        'is_heir' => 'Is Heir',
        'heir_from_name' => 'Heir From (Deceased Name)',
        'death_place' => 'Death Place',
        'death_date' => 'Death Date',
        'death_certificate_number' => 'Death Certificate Number',
        'death_certificate_issuer' => 'Death Certificate Issuer',
        'death_certificate_date' => 'Death Certificate Date',
    ...
    'placeholders' => [
        ...
        'heir_from_name' => 'Enter name of deceased person',
        'death_place' => 'Enter place of death',
        'death_date' => 'Select date of death',
        'death_certificate_number' => 'Enter death certificate number',
        'death_certificate_issuer' => 'Enter issuing authority',
        'death_certificate_date' => 'Select death certificate date',
