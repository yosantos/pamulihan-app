...
class DocumentLegalizationOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $total = DocumentLegalization::whereBetween('date', [$startDate, $endDate])->count();

        return [
            Stat::make(__('dashboard.document_legalizations'), $total)
                ->description(__('dashboard.total_legalizations'))
